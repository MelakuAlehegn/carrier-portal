    ...
    >
      ...
      <div class="relative w-full">
        <input
          ...
          required
          v-model="password"
          @input="toggleConfirmPasswordVisibility"
          class="p-2 mt-[15px] mb-[10px] block bg-lightGrey w-full border-b border-bluePrimary rounded-lg focus:outline-none focus:border-orangePrimary pr-[40px]"
        />
        <span class="absolute inset-y-0 right-0 flex items-center pr-3">
          <i
