      ...
      <div class="flex justify-between items-center py-4">
        ...
        :class="{
         ...
         class="hidden text-white md:flex items-center space-x-8 pt-4">
          ...
          <a href="/jobs" class="hover:text-orangePrimary" :class="{'text-bluePrimary': scrolled}">Jobs</a>
        ...
        <div class="md:hidden">
          <button
            ...
            :class="{'bg-white': !scrolled, 'bg-orangePrimary': scrolled, 'text-white': scrolled}"
          >
            <svg
              class="h-6 w-6"
              fill="none"
